...
import { Terminal, X, Clock, CheckCircle, XCircle, Copy, Check } from 'lucide-react';
      ...
      <div className="flex items-center justify-between mb-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="p-1.5 rounded hover:bg-emerald-400/10 text-emerald-400/60 hover:text-emerald-400 transition-colors"
            title="Copy output"
          >
          ...
          {output.output.split('\n').map((line, i) => (
            <div key={i} className={
              line.includes('Error') || line.includes('error') 
                ? 'text-red-400' 
                : line.includes('success') || line.includes('finished') || line.includes('exit code 0')
                  ? 'text-emerald-400' 
                  : 'text-emerald-200/70'
            }>
              {line || ' '}
